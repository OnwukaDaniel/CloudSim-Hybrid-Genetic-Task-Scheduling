...
public class CloudSimExample6 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DatacenterBrokerResearch broker = createBroker();
	...
	private static DatacenterBrokerResearch createBroker(){

		DatacenterBrokerResearch broker = null;
		try {
			broker = new DatacenterBrokerResearch("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
